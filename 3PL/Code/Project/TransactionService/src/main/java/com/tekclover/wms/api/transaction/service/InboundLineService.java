...
public class InboundLineService extends BaseService {
	...
	//V2
	public List<InboundLineV2> findInboundLineV2(SearchInboundLineV2 searchInboundLine) throws Exception {
		...
		List<InboundLineV2> results = inboundLineV2Repository.findAll(spec);
		return results;
	}
