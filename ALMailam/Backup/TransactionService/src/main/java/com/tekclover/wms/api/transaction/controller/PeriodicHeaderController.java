...
public class PeriodicHeaderController {
	...
	public ResponseEntity<?> getPeriodicHeaderV2(@PathVariable String cycleCountNo, @RequestParam String companyCodeId, @RequestParam String plantId,
												  @RequestParam String languageId, @RequestParam String warehouseId,
												  @RequestParam Long cycleCountTypeId) {
		PeriodicHeaderEntityV2 periodicHeaderV2 =
				periodicheaderService.getPeriodicHeaderWithLineV2(companyCodeId, plantId, languageId, warehouseId, cycleCountTypeId, cycleCountNo);
...
//	}
	...
	public ResponseEntity<?> patchPeriodicHeader(@PathVariable String cycleCountNo, @RequestParam String companyCodeId, @RequestParam String plantId,
													@RequestParam String languageId, @RequestParam String warehouseId,
													@RequestParam Long cycleCountTypeId,
		...
		PeriodicHeaderV2 createPeriodicHeader =
				periodicheaderService.updatePeriodicHeaderV2(companyCodeId, plantId, languageId, warehouseId,
