        ...
        if (stockAdjustmentList != null) {
            ...
            for (StockAdjustment stockAdjustment : stockAdjustments) {
                try {
                    ...
                    StockAdjustment dbStockAdjustment = stockAdjustmentService.processStockAdjustment(stockAdjustment);
                    if (dbStockAdjustment != null) {
                        // Updating the Processed Status
                        stockAdjustmentService.updateProcessedOrderV2(stockAdjustment.getStockAdjustmentId());
