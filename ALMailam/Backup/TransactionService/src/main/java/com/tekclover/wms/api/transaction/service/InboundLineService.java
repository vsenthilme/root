...
public class InboundLineService extends BaseService {
     ...
     * @throws InvocationTargetException
     */
    public InboundLineV2 confirmInboundLineV2(List<InboundLineV2> newInboundLines, String loginUserID) throws IllegalAccessException, InvocationTargetException {
