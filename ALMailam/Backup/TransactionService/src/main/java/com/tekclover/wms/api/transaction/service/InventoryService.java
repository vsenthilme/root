...
//			dbInventoryMovement.setRefDocNumber("");
    ...
    public List<InventoryV2> getInventoryForOrderManagementV2(String companyCodeId, String plantId, String languageId, String warehouseId,
        ...
        List<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndAndStockTypeIdAndBinClassIdAndManufacturerNameAndInventoryQuantityGreaterThanAndDeletionIndicator(
                        languageId,
                        companyCodeId,
                        plantId,
                        warehouseId,
    ...
    public List<InventoryV2> getInventoryForInhouseTransferV2(String companyCode, String plantId, String languageId,
        ...
        List<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndManufacturerCodeAndDeletionIndicator(
                        languageId,
                        companyCode,
                        plantId,
                        warehouseId,
...
//    }
    ...
    public List<InventoryV2> getInventoryForOrderMgmtV2(String companyCodeId, String plantId, String languageId, String warehouseId,
        ...
        List<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndBinClassIdAndStorageBinAndStockTypeIdAndDeletionIndicatorAndInventoryQuantityGreaterThanOrderByInventoryQuantity(
                        languageId,
                        companyCodeId,
                        plantId,
                        warehouseId,
...
//                );
    ...
    public InventoryV2 getInventoryForInhouseTransferV2(String companyCode, String plantId, String languageId, String warehouseId,
        ...
        log.info("getInventory----------> : " + warehouseId + "," + packBarcodes + "," + itemCode + "," + storageBin);
        Optional<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPackBarcodesAndItemCodeAndManufacturerCodeAndStorageBinAndDeletionIndicator(
                        languageId,
                        companyCode,
                        plantId,
                        warehouseId,
    ...
    public InventoryV2 getInventoryForAllocationV2(String companyCode, String plantId, String languageId, String warehouseId,
        ...
        log.info("getInventory----------> : " + warehouseId + "," + packBarcodes + "," + itemCode + "," + storageBin);
        Optional<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPackBarcodesAndItemCodeAndStorageBinAndManufacturerNameAndDeletionIndicator(
                        languageId,
                        companyCode,
                        plantId,
                        warehouseId,
     ...
     * @return
     */
    public List<InventoryV2> getInventoryForDeliveryConfirmationV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                                   String itemCode, String packBarcodes, Long binClassId) {
        List<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndItemCodeAndPackBarcodesAndBinClassIdAndDeletionIndicator(
                        languageId,
                        companyCodeId,
                        plantId,
                        warehouseId,
    ...
    public InventoryV2 getInventoryByStorageBinV2(String companyCode, String plantId, String languageId, String warehouseId, String storageBin) {
        Optional<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndStorageBinAndDeletionIndicator(
                        languageId,
                        companyCode,
                        plantId,
                        warehouseId,
     ...
     * @return
     */
    public List<InventoryV2> getInventoryForPutawayHeader(String itemCode, String manufacturerName, Long binClassId, String companycode, String plantId, String languageId, String warehouseId) {
        ...
        List<InventoryV2> stBinInventoryList =
                inventoryV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndItemCodeAndManufacturerNameAndBinClassIdAndDeletionIndicator(
    ...
    public List<IInventoryImpl> findInventoryNewV2(SearchInventoryV2 searchInventory)
        ...
        List<IInventoryImpl> results = inventoryV2Repository.findInventory(
     ...
     * @return
     */
    public List<InventoryV2> getInventoryForDeleteV2(String companyCodeId, String plantId, String languageId, String warehouseId, String packBarcodes, String itemCode) {
        List<InventoryV2> inventory =
                inventoryV2Repository.findByLanguageIdAndCompanyCodeIdAndPlantIdAndWarehouseIdAndPackBarcodesAndItemCodeAndDeletionIndicator(
                        languageId,
                        companyCodeId,
                        plantId,
                        warehouseId,
     ...
     * @param itemCode
     */
    public boolean deleteInventoryV2(String companyCodeId, String plantId, String languageId, String warehouseId, String packBarcodes, String itemCode) {
        try {
            List<InventoryV2> inventoryList = getInventoryForDeleteV2(companyCodeId, plantId, languageId, warehouseId, packBarcodes, itemCode);
            log.info("inventoryList : " + inventoryList);
            if (inventoryList != null) {
