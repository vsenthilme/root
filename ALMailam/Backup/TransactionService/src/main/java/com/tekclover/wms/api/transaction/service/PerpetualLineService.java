...
//					createInventoryMovement (updatedPerpetualLine);
     ...
     * @return
     */
    public List<PerpetualLineV2> getPerpetualLineV2(String companyCodeId, String plantId, String languageId, String warehouseId,
                                                    String cycleCountNo, List<String> cycleCounterId) {
        List<PerpetualLineV2> perpetualLine =
                perpetualLineV2Repository.findByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndCycleCountNoAndCycleCounterIdInAndDeletionIndicator(
                        companyCodeId, plantId, languageId, warehouseId, cycleCountNo, cycleCounterId, 0L);
        return perpetualLine;
    }
     ...
     * @throws InvocationTargetException
     */
    public PerpetualLineV2 createPerpetualLineV2(PerpetualLineV2 newPerpetualLine, String loginUserID) {
...
//                    dbPerpetualLine.setStatusId(78L);
                    ...
                    if (updatePerpetualLine.getSecondCountedQty() != null) {
                        dbPerpetualLine.setStatusId(78L);
                        dbPerpetualLine.setCycleCountAction(SKIP);
                    }
...
//            log.info("PerpetualUpdateResponse------> : " + response);
     ...
     * @return
     */
    private InventoryMovement createInventoryMovementV2(PerpetualLineV2 updatedPerpetualLine) {
        InventoryMovement inventoryMovement = new InventoryMovement();
        BeanUtils.copyProperties(updatedPerpetualLine, inventoryMovement, CommonUtils.getNullPropertyNames(updatedPerpetualLine));
