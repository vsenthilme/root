...
//	}
    ...
    public List<PickupLineV2> getPickupLineAutomation(String companyCodeId, String plantId, String languageId, String warehouseId,
        ...
        List<PickupLineV2> pickupLine = pickupLineV2Repository
                .findAllByCompanyCodeIdAndPlantIdAndLanguageIdAndWarehouseIdAndStatusIdAndAssignedPickerIdInAndDeletionIndicatorOrderByPickupCreatedOn(
                        ...
                        if (INV_QTY == 0) {
                            ...
                            try {
                                ...
                                InventoryV2 inventoryByStBin = inventoryService.getInventoryByStorageBinV2(dbPickupLine.getCompanyCodeId(),
                                        ...
                                        warehouseId, inventory.getStorageBin());
                                if (inventoryByStBin == null) {
                                    ...
                                    mastersService.updateStorageBinV2(inventory.getStorageBin(), dbStorageBin, dbPickupLine.getCompanyCodeId(),
                                            dbPickupLine.getPlantId(), dbPickupLine.getLanguageId(), warehouseId, loginUserID,
                                            authTokenForMastersService.getAccess_token());
                                }
                            } catch (Exception e) {
                                log.error("updateStorageBin Error :" + e.toString());
...
//                        }
//                        if (dbPickupLine.getPickedCbm() == null) {
//                            dbPickupLine.setPickedCbm(0D);
//                        }
//                        cbm = Double.valueOf(inventory.getCbm()) - dbPickupLine.getPickedCbm();
//
//                        inventory.setCbm(String.valueOf(cbm));
                        ...
                        //-------------------------------------------------------------------
                        InventoryV2 inventoryBySTBIN = inventoryService.getInventoryByStorageBinV2(dbPickupLine.getCompanyCodeId(),
                                dbPickupLine.getPlantId(), dbPickupLine.getLanguageId(), warehouseId, dbPickupLine.getPickedStorageBin());
                        //if (INV_QTY == 0) {
                        if (inventoryBySTBIN != null && (inventoryBySTBIN.getAllocatedQuantity() == null || inventoryBySTBIN.getAllocatedQuantity() == 0D)
                                && (inventoryBySTBIN.getInventoryQuantity() == null || inventoryBySTBIN.getInventoryQuantity() == 0D)) {
                            try {
...
//            StatusId idStatus = idmasterService.getStatus(STATUS_ID, warehouseId, authTokenForIDService.getAccess_token());
    ...
    public List<PickupLineV2> updatePickupLineForConfirmationV2(String companyCodeId, String plantId, String languageId, String warehouseId, String preOutboundNo,
                                                                String refDocNumber, String partnerCode, Long lineNumber, String itemCode, String loginUserID,
                                                                PickupLineV2 updatePickupLine) throws IllegalAccessException, InvocationTargetException {
     ...
     * @throws InvocationTargetException
     */
    public List<PickupLineV2> deletePickupLineForReversalV2(String companyCodeId, String plantId, String languageId, String warehouseId, String preOutboundNo, String refDocNumber,
                                                            String partnerCode, Long lineNumber, String itemCode, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
     ...
     * @return
     */
    private List<InventoryV2> fetchAdditionalBinsV2(String companyCodeId, String plantId, String languageId, List<String> storageSectionIds, String warehouseId,
                                                    String itemCode, String proposedPackBarCode, String proposedStorageBin) {
        List<InventoryV2> finalizedInventoryList = new ArrayList<>();
        List<InventoryV2> listInventory = inventoryService.getInventoryForAdditionalBinsV2(companyCodeId, plantId, languageId, warehouseId, itemCode,
                storageSectionIds);
        log.info("selected listInventory--------: " + listInventory);
        boolean toBeIncluded = false;
     ...
     * @return
     */
    private List<InventoryV2> fetchAdditionalBinsForOB2V2(String companyCodeId, String plantId, String languageId, List<String> storageSectionIds, String warehouseId,
                                                          String itemCode, String proposedPackBarCode, String proposedStorageBin) {
        List<InventoryV2> listInventory = inventoryService.getInventoryForAdditionalBinsForOB2V2(companyCodeId, plantId, languageId, warehouseId,
