...
public interface PerpetualLineTempV2Repository extends JpaRepository<PerpetualLineTempV2, Long>,
    ...
    @Query(value = "SELECT SUM(INV_QTY) inventoryQty, itm_code itemCode, mfr_name manufacturerName, ref_no referenceCycleCountNo FROM tblperpetualtempline WHERE WH_ID = :warehouseId AND CC_NO = :cycleCountNo AND\r\n"
