...
public class PutAwayHeaderService extends BaseService {
    ...
    public List<PutAwayHeaderV2> updatePutAwayHeaderV2(String companyCode, String plantId, String languageId,
        ...
        List<InventoryV2> createInventoryMovement = null;
...
//                    ImBasicData1 itemCodeCapacityCheck = mastersService.getImBasicData1ByItemCodeV2(itemCode, languageId, companyCode, plantId, warehouseId,
//                            dbPutAwayLine.getManufacturerName(), authTokenForMastersService.getAccess_token());
                    ...
                    List<InventoryV2> updateStorageBinList = 
                    		inventoryService.getInventoryForDeleteV2(companyCode, plantId, languageId, warehouseId, packBarcodes, itemCode);
                    createInventoryMovement = inventoryService.getInventoryForInvMmt(companyCode, plantId, languageId, warehouseId, itemCode, 1L);

                    /*
                     * On Successful reversal, update INVENTORY table as below
                     * Pass WH_ID/PACK_BARCODE/ITM_CODE values in Inventory table and delete the records
                     */
                    boolean isDeleted = inventoryService.deleteInventoryV2(companyCode, plantId, languageId, warehouseId, packBarcodes, itemCode);
                    log.info("deleteInventory deleted.." + isDeleted);
...
//                        dbPutAwayLine.setStatusDescription(statusDescription);
            ...
            if (dbPutAwayHeader.getStatusId() == 19L) {
                ...
                List<InventoryV2> updateStorageBinList = inventoryService.getInventoryForDeleteV2(companyCode, plantId, languageId, warehouseId, packBarcodes, itemCode);
                createInventoryMovement = inventoryService.getInventoryForInvMmt(companyCode, plantId, languageId, warehouseId, itemCode, 1L);

//                ImBasicData1 itemCodeCapacityCheck = mastersService.getImBasicData1ByItemCodeV2(itemCode, languageId, companyCode, plantId, warehouseId,
//                        manufactureName, authTokenForMastersService.getAccess_token());
...
//                    dbPutAwayHeader.setStatusDescription(statusDescription);
        ...
        //update the statusId to complete revesal process
     ...
     * @param storageBin
     */
    private void createInventoryMovementV2(GrLineV2 grLine, List<InventoryV2> createInventoryMovement, String caseCode, String palletCode, String storageBin) {
        InventoryMovement inventoryMovement = new InventoryMovement();
        BeanUtils.copyProperties(grLine, inventoryMovement, CommonUtils.getNullPropertyNames(grLine));
