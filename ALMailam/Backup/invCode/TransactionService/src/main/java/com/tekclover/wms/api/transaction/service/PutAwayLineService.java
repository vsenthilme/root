...
//							log.info("inboundLine updated : " + inboundLine);
    ...
    public List<PutAwayLineV2> getPutAwayLineForPerpetualCountV2(String companyCode, String plantId, String languageId, String warehouseId,
        ...
        List<PutAwayLineV2> putAwayLine =
                putAwayLineV2Repository.findByLanguageIdAndCompanyCodeAndPlantIdAndWarehouseIdAndItemCodeAndManufacturerNameAndProposedStorageBinAndStatusIdAndCreatedOnBetweenAndDeletionIndicator(
                        languageId,
                        companyCode,
                        plantId,
                        warehouseId,
...
//                        newPutAwayLine.getManufacturerName(), authTokenForMastersService.getAccess_token());
