...
//	}
	...
	public List<StockReport> getAllStockReport(List<String> languageId, List<String> companyCodeId, List<String> plantId,
											   List<String> warehouseId, List<String> itemCode, String itemText, String stockTypeText) {
		...
		List<StockReport> stockReportList = new ArrayList<>();
		List<StockReportImpl> reportList = inventoryRepository.getAllStockReport(languageId, companyCodeId, plantId,
