...
public class HandlingEquipmentIdController {
	...
	public ResponseEntity<?> getHandlingEquipmentId(@PathVariable String handlingEquipmentId, @RequestParam String handlingEquipmentNumber,
    	...
    	HandlingEquipmentId handlingequipmentid = 
    			handlingequipmentidService.getHandlingEquipmentId(warehouseId, handlingEquipmentId,handlingEquipmentNumber,companyCodeId,languageId,plantId);
	...
	public ResponseEntity<?> patchHandlingEquipmentId(@PathVariable String handlingEquipmentId,@RequestParam String handlingEquipmentNumber,
		...
		HandlingEquipmentId createdHandlingEquipmentId = 
				handlingequipmentidService.updateHandlingEquipmentId(warehouseId, handlingEquipmentId,handlingEquipmentNumber,companyCodeId,languageId,plantId,loginUserID, updateHandlingEquipmentId);
		return new ResponseEntity<>(createdHandlingEquipmentId , HttpStatus.OK);
	}
	...
	public ResponseEntity<?> deleteHandlingEquipmentId(@PathVariable String handlingEquipmentId,@RequestParam String handlingEquipmentNumber,
			@RequestParam String warehouseId,@RequestParam String companyCodeId,@RequestParam String languageId,@RequestParam String plantId,@RequestParam String loginUserID) {
    	handlingequipmentidService.deleteHandlingEquipmentId(warehouseId, handlingEquipmentId,handlingEquipmentNumber,companyCodeId,languageId,plantId,loginUserID);
	...
	public ResponseEntity<?> findHandlingEquipmentId(@Valid @RequestBody FindHandlingEquipmentId findHandlingEquipmentId) throws Exception {
		List<HandlingEquipmentId> createdHandlingEquipmentId = handlingequipmentidService.findHandlingEquipmentId(findHandlingEquipmentId);
		return new ResponseEntity<>(createdHandlingEquipmentId, HttpStatus.OK);
	}
}