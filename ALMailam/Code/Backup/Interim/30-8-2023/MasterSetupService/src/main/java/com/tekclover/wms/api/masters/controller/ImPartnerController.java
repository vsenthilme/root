...
public class ImPartnerController {
	...
	public ResponseEntity<?> getImPartner(@PathVariable String businessPartnerCode,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String languageId,
										  @RequestParam String partnerItemBarcode,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam String businessPartnerType) {
    	ImPartner impartner = impartnerService.getImPartner(businessPartnerCode,companyCodeId,plantId,languageId,warehouseId,itemCode,businessPartnerType,partnerItemBarcode);
//    	log.info("ImPartner : " + impartner);
	...
	public ResponseEntity<?> patchImPartner(@PathVariable String businessPartnerCode,@RequestParam String partnerItemBarcode,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String languageId,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam String businessPartnerType,
			@Valid @RequestBody UpdateImPartner updateImPartner, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		ImPartner createdImPartner = impartnerService.updateImPartner(businessPartnerCode,companyCodeId,plantId,languageId,warehouseId,itemCode,businessPartnerType,partnerItemBarcode, updateImPartner, loginUserID);
		return new ResponseEntity<>(createdImPartner , HttpStatus.OK);
	}
    
    @ApiOperation(response = ImPartner.class, value = "Delete ImPartner") // label for swagger
	@DeleteMapping("/{businessPartnerCode}")
	public ResponseEntity<?> deleteImPartner(@PathVariable String businessPartnerCode,@RequestParam String partnerItemBarcode,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String languageId,String warehouseId,String itemCode,String businessPartnerType, @RequestParam String loginUserID) {
    	impartnerService.deleteImPartner(businessPartnerCode,companyCodeId,plantId,languageId,warehouseId,itemCode,businessPartnerType,partnerItemBarcode,loginUserID);
