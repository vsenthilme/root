...
public class ImStrategiesController {
	...
	public ResponseEntity<?> getImStrategies(@PathVariable String strategeyTypeId,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam Long sequenceIndicator,@RequestParam String languageId) {
    	ImStrategies imstrategies = imstrategiesService.getImStrategies(strategeyTypeId,companyCodeId,plantId,warehouseId,itemCode,sequenceIndicator,languageId);
//    	log.info("ImStrategies : " + imstrategies);
	...
	public ResponseEntity<?> patchImStrategies(@PathVariable String strategeyTypeId,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam Long sequenceIndicator,@RequestParam String languageId,
			@Valid @RequestBody UpdateImStrategies updateImStrategies, @RequestParam String loginUserID) 
			throws IllegalAccessException, InvocationTargetException {
		ImStrategies createdImStrategies = imstrategiesService.updateImStrategies(strategeyTypeId,companyCodeId,plantId,warehouseId,itemCode,sequenceIndicator,languageId,updateImStrategies, loginUserID);
		return new ResponseEntity<>(createdImStrategies , HttpStatus.OK);
	}
    
    @ApiOperation(response = ImStrategies.class, value = "Delete ImStrategies") // label for swagger
	@DeleteMapping("/{strategeyTypeId}")
	public ResponseEntity<?> deleteImStrategies(@PathVariable String strategeyTypeId,@RequestParam String companyCodeId,@RequestParam String plantId,@RequestParam String warehouseId,@RequestParam String itemCode,@RequestParam Long sequenceIndicator,@RequestParam String languageId,@RequestParam String loginUserID) {
    	imstrategiesService.deleteImStrategies(strategeyTypeId,companyCodeId,plantId,warehouseId,itemCode,sequenceIndicator,languageId,loginUserID);
