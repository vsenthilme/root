...
public class NumberRangeStorageBinController {
    ...
    public ResponseEntity<?> getNumberRangeStorageBin(@RequestParam String warehouseId, @PathVariable Long storageSectionId,@RequestParam Long floorId,
        ...
        NumberRangeStorageBin numberRangeStorageBin =
                numberRangeStorageBinService.getNumberRangeStorageBin(warehouseId,companyCodeId,languageId,plantId,floorId,rowId,storageSectionId,aisleNumber);
    ...
    public ResponseEntity<?> patchCbmInbound(@RequestParam String warehouseId, @PathVariable Long storageSectionId, @RequestParam Long floorId, @RequestParam String rowId, @RequestParam String aisleNumber, @RequestParam String companyCodeId,
                                             @RequestParam String languageId, @RequestParam String plantId,
        ...
        NumberRangeStorageBin createdNumberRangeStorageBin =
                numberRangeStorageBinService.updateNumberRangeItem(companyCodeId,plantId,warehouseId,languageId,floorId,storageSectionId,rowId,aisleNumber,updateNumberRangeStorageBin,loginUserID);
        return new ResponseEntity<>(createdNumberRangeStorageBin, HttpStatus.OK);
    }
    ...
    public ResponseEntity<?> deleteNumberRangeStorageBin(@RequestParam String warehouseId,@PathVariable Long storageSectionId,@RequestParam Long floorId,@RequestParam String rowId,@RequestParam String aisleNumber,@RequestParam String companyCodeId,
                                              @RequestParam String languageId,@RequestParam String plantId,
                                              @RequestParam String loginUserID) {
        numberRangeStorageBinService.deleteNumberRangeStorageBin(companyCodeId,languageId,plantId,warehouseId,floorId,storageSectionId,rowId,aisleNumber,loginUserID);
