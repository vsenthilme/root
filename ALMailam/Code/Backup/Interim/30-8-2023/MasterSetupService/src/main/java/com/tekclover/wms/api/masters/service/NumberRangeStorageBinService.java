...
public class NumberRangeStorageBinService {
     ...
     * @return
     */
    public NumberRangeStorageBin getNumberRangeStorageBin (String warehouseId, String companyCodeId, String languageId, String plantId,Long floorId,String rowId,Long storageSectionId,String aisleNumber) {
     ...
     * @throws InvocationTargetException
     */
    public NumberRangeStorageBin updateNumberRangeItem (String companyCodeId, String plantId, String warehouseId, String languageId, Long floorId, Long storageSectionId, String rowId, String aisleNumber, UpdateNumberRangeStorageBin updateNumberRangeStorageBin, String loginUserID)
            throws IllegalAccessException, InvocationTargetException {
        NumberRangeStorageBin dbNumberRangeStorageBin = getNumberRangeStorageBin(warehouseId,companyCodeId,languageId,plantId,floorId,rowId,storageSectionId,aisleNumber);
        BeanUtils.copyProperties(updateNumberRangeStorageBin, dbNumberRangeStorageBin, CommonUtils.getNullPropertyNames(updateNumberRangeStorageBin));
        dbNumberRangeStorageBin.setUpdatedBy(loginUserID);
        dbNumberRangeStorageBin.setUpdatedOn(new Date());
        return numberRangeStorageBinRepository.save(dbNumberRangeStorageBin);
    }
     ...
     * @param rowId
     */
    public void deleteNumberRangeStorageBin (String companyCodeId,String languageId,String plantId,String warehouseId,Long floorId,Long storageSectionId,String rowId,String aisleNumber,String loginUserID) {
        NumberRangeStorageBin numberRangeStorageBin = getNumberRangeStorageBin(warehouseId,companyCodeId,languageId,plantId,floorId,rowId,storageSectionId,aisleNumber);
