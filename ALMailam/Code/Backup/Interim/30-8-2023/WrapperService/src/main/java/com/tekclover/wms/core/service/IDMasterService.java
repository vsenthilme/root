...
//			log.info("result : " + result.getStatusCode());
	...
	// GET
	public HhtUser getHhtUser (String userId, String warehouseId,String companyCodeId,String plantId,String languageId,String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "RestTemplate");
	...
	// PATCH
	public HhtUser updateHhtUser (String userId, String warehouseId,String companyCodeId,String languageId,String plantId,
	...
	// DELETE
	public boolean deleteHhtUser ( String warehouseId, String userId,String companyCodeId,String languageId,String plantId, String loginUserID, String authToken) {
		try {
			HttpHeaders headers = new HttpHeaders();
			headers.setAccept(Collections.singletonList(MediaType.APPLICATION_JSON));
			headers.add("User-Agent", "MNRClara's RestTemplate");
