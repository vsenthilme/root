...
//    }
    ...
    @Transactional
    public List<GrLineV2> createGrLineNonCBMV2(@Valid List<AddGrLineV2> newGrLines, String loginUserID) throws java.text.ParseException, IOException {
...
//        }
    ...
    public List<GrLineV2> createGrLineV2(@Valid List<AddGrLineV2> newGrLines, String loginUserID)
            throws IllegalAccessException, InvocationTargetException, java.text.ParseException, IOException {
        List<GrLineV2> createdGRLines = new ArrayList<>();
        try {
            AuthToken authTokenForMastersService = authTokenService.getMastersServiceAuthToken();
...
//            inventory.setPackBarcodes(createdGRLine.getPackBarcodes());
    ...
    private void createGrLineLog10(List<AddGrLineV2> grLineV2List, String error) throws IOException {
