...
public class DeliveryLineController {
    ...
    public ResponseEntity<?> patchDeliveryLine(@RequestParam String companyCodeId, @RequestParam String plantId,
        ...
        List<DeliveryLine> deliveryLine = deliveryLineService.updateDeliveryLine(companyCodeId, plantId,
                warehouseId, deliveryNo, languageId, itemCode, lineNumber, invoiceNumber, refDocNumber, updateDeliveryLine, loginUserID);
        return new ResponseEntity<>(deliveryLine, HttpStatus.OK);
