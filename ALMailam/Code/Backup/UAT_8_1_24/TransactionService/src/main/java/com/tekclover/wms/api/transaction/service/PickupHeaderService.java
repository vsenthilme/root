...
//        }
    ...
    /**
     * findPickUpHeaderWithStatusId
     *
     * @param findPickUpHeader
     * @return
     */
    public PickUpHeaderReport findPickUpHeaderWithStatusId(FindPickUpHeader findPickUpHeader) throws java.text.ParseException {
        ...
        pickUpHeaderReport.setPickupHeaderV2(new ArrayList<>());

        List<PickUpHeaderCount> pickupHeaderV2List = new ArrayList<>();
        ...
        for (PickupHeaderV2 pickUpHeader : results) {
            if (pickUpHeader.getStatusId() == 48) {
                ...
                pickupHeaderV2List.add(pickUpHeaderCount);
            }
        }
        pickUpHeaderReport.setPickupHeaderV2(pickupHeaderV2List);
        pickUpHeaderReport.setPickUpHeaderCount(String.valueOf(pickupHeaderV2List.size()));
