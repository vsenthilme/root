...
export class LabelGenerateComponent implements OnInit {
  constructor(public dialogRef: MatDialogRef<any>, private auth: AuthService, private service: ItemReceiptService,private partnerservice:PartnerService , @Inject(MAT_DIALOG_DATA) public data: any,
