...
export class DeliveryService {
  ...
  Delete(deliveryNo: any) {
    return this.http.delete<any>(`/wms-transaction-service/deliveryheader/` +  deliveryNo +'?warehouseId=' + this.auth.warehouseId +'&languageId=' + this.auth.languageId+ '&plantId=' + this.auth.plantId +'&companyCodeId=' + this.auth.companyId);
  }
}
