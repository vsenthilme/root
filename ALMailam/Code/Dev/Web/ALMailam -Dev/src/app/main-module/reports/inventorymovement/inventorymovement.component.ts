...
export class InventorymovementComponent implements OnInit {
  ...
  @ViewChild('inventorymovTag') inventorymovTag: Table | any;
    ...
    initialSearch(){
      ...
      this.form.controls.fromCreatedOn.patchValue(this.cs.day_callapi11(this.form.controls.fromCreatedOnFE.value));
      this.form.controls.toCreatedOn.patchValue(this.cs.day_callapi11(this.form.controls.toCreatedOnFE.value));
