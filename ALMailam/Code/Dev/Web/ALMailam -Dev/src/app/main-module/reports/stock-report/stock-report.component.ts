...
export class StockReportComponent implements OnInit {
  ...
  getStockReportData() {
    ...
    // });
    this.reportService.GetallDataStockReport([this.itemCode], this.itemText, this.stockTypeText, this.selectedItems,this.auth.companyId,this.auth.plantId,this.auth.languageId).subscribe(
      result => {
