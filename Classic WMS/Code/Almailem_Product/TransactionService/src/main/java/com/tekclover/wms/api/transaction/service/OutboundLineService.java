...
//					log.info("pickConfirmQty : " + pickConfirmQty);
     ...
     * @throws IllegalAccessException
     */
    public List<OutboundReversalV2> batchOutboundReversal(List<InboundReversalInput> outboundReversalInputList, String loginUserID) throws ParseException, java.text.ParseException, InvocationTargetException, IllegalAccessException, IOException, CsvException {
...
//        StatusId idStatus = idmasterService.getStatus(47L, pickupHeader.getWarehouseId(), idmasterAuthToken.getAccess_token());
     ...
     * @return
     */
    private InventoryV2 updateInventory1V2(PickupLineV2 pickupLine, Long statusId) throws IOException, CsvException {
        AuthToken authTokenForMastersService = authTokenService.getMastersServiceAuthToken();
        Long BIN_CLASS_ID = 5L;
        if (statusId == 50L) {
            BIN_CLASS_ID = 4L;
