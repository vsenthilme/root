...
export class ContainerMainComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select','actions', 'referenceField9',  'containerNo', 'containerReceiptNo', 'refDocNumber', 'partnerCode', 'createdBy', 'referenceField2','referenceField5'];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        "Status": this.cs.getstatus_text(x.statusId),  //x.referenceField9,
