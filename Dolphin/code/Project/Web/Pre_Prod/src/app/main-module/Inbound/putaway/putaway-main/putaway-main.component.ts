...
export class PutawayMainComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'actions', 'referenceField10','itemCode', 'refDocNumber', 'putAwayNumber', 'packBarcodes', 'proposedStorageBin', 'proposedHandlingEquipment', 'putAwayQuantity', 'createdBy', 'createdOn',];
  ...
  downloadexcel() {
    ...
    this.dataSource.data.forEach(x => {
      res.push({
        ...
        "Status ": this.cs.getstatus_text(x.statusId), //x.referenceField10,
