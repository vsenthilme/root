...
export class StocksamplereportComponent implements OnInit {
  ...
  showFiller = false;
  displayedColumns: string[] = ['itemCode','referenceField8','referenceField9', 'storageBin', 'referenceField10', 'packBarcodes', 'inventoryQuantity', 'allocatedQuantity', 'total', 'stockTypeId', 'inventoryUom', 'createdBy' , 'createdOn', 'asnNumber'  ];
