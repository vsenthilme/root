...
export class UserprofileComponent implements OnInit {
 ...
 screenid=3160;
  ...
  getAll() {
    ...
    this.sub.add(this.service.findProfileNew(obj).subscribe((res: any[]) => {
      console.log(res)
if(res){
  ...
  deleterecord(id: any,warehouseId:any,companyCode:any,languageId:any,plantId:any,userRoleId:any) {
    this.spin.show();
    this.sub.add(this.service.DeleteNew(id,warehouseId,companyCode,languageId,plantId,userRoleId).subscribe((res) => {
