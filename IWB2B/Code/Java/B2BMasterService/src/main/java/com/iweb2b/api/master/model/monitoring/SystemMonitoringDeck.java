...
@AllArgsConstructor
@NoArgsConstructor
@Table(name = "tblsystemmonitoringdeck")
public class SystemMonitoringDeck {
	...
	@Column(name = "DOCUMENT_CREATION_FAILURE")
	private String documentCreationFailure;
		
	@Column(name = "SYSTEM_ISSUES")
	private String systemIssues;
	
	@Column(name = "SYSTEM_API_FAILURES")
