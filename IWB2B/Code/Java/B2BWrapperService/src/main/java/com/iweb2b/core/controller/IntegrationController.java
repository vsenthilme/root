...
//	}
	...
	//FIND
	@ApiOperation(response = ConsignmentSpark[].class, value = "Find Consignment Spark")//label for swagger
	@PostMapping("/consignment/findConsignmentSpark")
	public ConsignmentSpark[] findConsignmentSpark(@RequestBody FindConsignment findConsignment)throws Exception{
		return integrationService.findConsignmentSpark(findConsignment);
	}
}
