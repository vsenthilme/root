...
//			log.info("Webhook Hub_code() : " + createdConsignmentWebhookEntity.getHub_code());
            ...
            if (createdConsignmentWebhook.getCustomer_code() != null &&
            		createdConsignmentWebhook.getCustomer_code().equalsIgnoreCase("AJX")) {
            	sendFeedToAJEX(createdConsignmentWebhook);
            }
...
//	            return result.getBody();
     ...
     */
    private void sendFeedToAJEX (ConsignmentWebhook createdConsignmentWebhook) {
    	// Send Feed to AJEX
    }
	...
	public List<ConsignmentWebhookEntity> scanInventory(InventoryScanRequest inventoryScanRequest) {
		List<ConsignmentWebhookEntity> webhooks = 
				consignmentWebhookRepository.findByEvent_timeBetween (inventoryScanRequest.getFromDate(), inventoryScanRequest.getToDate());
		return webhooks;
	}
}
