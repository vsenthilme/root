...
//			Date fromPostingDate, Date toPostingDate, Long delInd);
    ...
    public IBilledHourReportMatterTimeTicket getMatterTimeTicketByMatterNumberWOTKCode(
    ...
    public IBilledHourReportMatterTimeTicket getMatterTimeTicketByMatterNumberWithTKCode(
    		@Param(value = "preBillNumber") String preBillNumber,
    		@Param(value = "matterNumber") String matterNumber,
