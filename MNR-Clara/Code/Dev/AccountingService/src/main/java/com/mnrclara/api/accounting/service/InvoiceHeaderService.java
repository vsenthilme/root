...
public class InvoiceHeaderService {
	 ...
	 */
	public List<com.mnrclara.api.accounting.model.invoice.spark.InvoiceHeader> findInvoiceHeader(SearchInvoiceHeader searchInvoiceHeader) throws ParseException {
...
//		return responseAddInvoiceHeaderList;
		...
		com.mnrclara.api.accounting.model.invoice.spark.InvoiceHeader[] results = sparkService.getInvoiceHeaders(searchInvoiceHeader);
		log.info("AddInvoiceHeader ---------> : " + results);	
...
//			log.info("results: " + invPreBillDetails);
	 ...
	 */
	public List<AddInvoiceHeader> createInvoiceHeader (List<AddInvoiceHeader> newInvoiceHeaders, String loginUserID)
		...
		for (AddInvoiceHeader newInvoiceHeader : newInvoiceHeaders) {
			...
			for (AddInvoiceLine addInvoiceLine : newInvoiceHeader.getAddInvoiceLine()) {
				 ...
				 */
				PreBillDetails preBillDetails = preBillDetailsRepository.findByPreBillNumber(createdInvoiceHeader.getPreBillNumber());
