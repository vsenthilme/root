...
public class AccountingServiceController { 
	...
	@ApiOperation(response = Optional.class, value = "Dashboard -  Partner Billed Hours Paid Report") // label for swagger
	@PostMapping("/dashboard/partnerBilledHoursPaid")
	public ResponseEntity<?> getPartnerBilledHoursPaidReport (@RequestBody BilledHoursPaid requestData, @RequestParam String authToken)
			throws Exception {
		BilledHoursReport[] data = accountingService.getPartnerBilledHoursPaidReport(requestData,authToken);
		return new ResponseEntity<>(data, HttpStatus.OK);
	}
...
//	}
	...
	@ApiOperation(response = BilledPaidFeesReportOutput.class, value = "Dashboard -  Billed Paid Fees Report") // label for swagger
	@PostMapping("/dashboard/billed-paid-fees-report")
	public ResponseEntity<?> getBilledHoursPaidReport (@RequestBody BilledPaidFees requestData, @RequestParam String authToken)
			throws Exception {
