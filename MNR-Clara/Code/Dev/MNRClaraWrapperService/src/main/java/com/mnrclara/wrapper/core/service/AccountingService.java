...
//			log.info("result : " + result);
	...
	// POST
	public com.mnrclara.wrapper.core.model.accounting.spark.InvoiceHeader[] findInvoiceHeader(SearchInvoiceHeader searchInvoiceHeader, String authToken) throws ParseException {
...
//		return arrInvoiceHeader;
		...
		ResponseEntity<com.mnrclara.wrapper.core.model.accounting.spark.InvoiceHeader[]> result = 
				getRestTemplate().exchange(builder.toUriString(), HttpMethod.POST, entity, com.mnrclara.wrapper.core.model.accounting.spark.InvoiceHeader[].class);
		return result.getBody();
	}
	...
	// POST
	public InvoiceHeader[] createInvoiceHeader (@Valid List<InvoiceHeader> newInvoiceHeaders, 
	...
	// PATCH 
	public AddInvoiceHeader updateInvoiceHeader(String invoiceNumber, @Valid UpdateInvoiceHeader updateInvoiceHeader,
		...
		try {
			...
			ResponseEntity<AddInvoiceHeader> result = 
					restTemplate.exchange(builder.toUriString(), HttpMethod.PATCH, entity, AddInvoiceHeader.class);
			log.info("result : " + result.getStatusCode());
			return result.getBody();
		} catch (Exception e) {
			e.printStackTrace();
