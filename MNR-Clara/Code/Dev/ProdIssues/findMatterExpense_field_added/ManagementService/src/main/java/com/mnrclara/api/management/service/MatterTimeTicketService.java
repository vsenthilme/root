...
public class MatterTimeTicketService {
     ...
     * @return
     */
    public MatterTimeTicketMobile getMatterTimeTicketMobile(String timeTicketNumber) {
        ...
        if (matterTimeTicket != null) {
            ...
            MatterTimeTicketMobile matterTimeTicketMobile = new MatterTimeTicketMobile();
