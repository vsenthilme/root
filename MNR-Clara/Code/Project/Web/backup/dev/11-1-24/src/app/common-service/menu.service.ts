...
export class MenuService {
...

  {
    ...
    },
    {
      ...
      {
        displayName: 'Immigration Payment Plan',
        iconName: 'far fa-file-alt mx-2 mr-3 font_1-5',
        route: '/main/reports/immigrationPayment',
        id: 1191,
        disabled: false,
      },
      {
    ...
    },
    {
      ...
      {
        displayName: 'Billed Hours Paid - Partner',
        iconName: 'fas fa-file-invoice-dollar mx-2 mr-3 font_1-5',
        route: '/main/reports/billedHoursPaidPartner',
        id: 1193,
        disabled: false,
      },
      {
