...
//public mask = [ '+','(', /[1-9]/,')', ' ', /\d/, /\d/, /\d/, '-', /\d/, /\d/, /\d/, /\d/]
  ...
  form = this.fb.group({
    ...
    //  isPermanentResident: [, [Validators.required]],
     ...
     permanentResidentOrUSC: [, []],
      ...
      questions: this.fb.group({
         //newFieldsAddedon16/11/2023
    howManyPeopleLiveWithYou:[,[Validators.required]],
    doAnyOfTheIndividualPayTaxesAlone:[,[Validators.required]],
    numberOfIndividualPayTaxesAlone:[,[]],
    annualHouseholdIncome:[,[Validators.required]],
    totalValueOfAssest:[,[Validators.required]],
    highestDegreeOrLevelOfSchool:[,[Validators.required]],
    listOfCertificateOrLicenses:[,[Validators.required]],
    haveYouReceivedAnySupplementaryIncomeOrTemporaryAssisstance:[,[Validators.required]],
    benefitReceived1:[,[]],
    benefitReceived2:[,[]],
    benefitReceived3:[,[]],
    benefitReceived4:[,[]],
    ...
    nameOfInstitution1:[,[]],
      ...
      cityAndState2:[,[]],
      cityAndState3:[,[]],
    haveYouReceivedLongTermInstitutionalizationAtGovtExpense:[,[Validators.required]],
    institutionalizationBenefitReceived1:[,[]],
    institutionalizationBenefitReceived2:[,[]],
    institutionalizationBenefitReceived3:[,[]],
    institutionalizationBenefitReceived4:[,[]],
    institutionalizationBenefitReceivedStartDate1:[],
    institutionalizationBenefitReceivedStartDate2:[],
    institutionalizationBenefitReceivedStartDate3:[],
    institutionalizationBenefitReceivedStartDate4:[],
    institutionalizationBenefitReceivedEndDate1:[],
    institutionalizationBenefitReceivedEndDate2:[],
    institutionalizationBenefitReceivedEndDate3:[],
    institutionalizationBenefitReceivedEndDate4:[],
    institutionalizationBenefitAmount1:[,[]],
    institutionalizationBenefitAmount2:[,[]],
    institutionalizationBenefitAmount3:[,[]],
    institutionalizationBenefitAmount4:[,[]],
