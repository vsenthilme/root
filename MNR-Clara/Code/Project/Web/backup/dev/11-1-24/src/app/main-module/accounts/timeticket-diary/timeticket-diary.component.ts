...
export class TimeticketDiaryComponent implements OnInit {
  ...
  timeTicketPoup(){
         // if(this.auth.timeNotification == 0 && this.auth.complaintNotification == 1 && this.auth.shown == 0){
          setTimeout(() => {
            // if (this.js == 'login') {
            //   if (this.actualHours >= 35 && this.shown == 0) {
            //     if (this.time == 0) {
            ...
            //     }
            //   }
            //   if (this.actualHours >= 35 && this.shown == 0 && this.time == null) {
            //     this.timeticketNofitication('filled');
            //   }
            //   if (this.actualHours < 35) {
            //     if (this.time == 0) {
            ...
            //     }
            //     if (this.time == null && this.actualHours < 35 && this.shown == 0) {
            //       this.timeticketNofitication('pmNotFilled');
            //     }
            //   }
            // }
...
  }
  ...
  //   }
  //   let paramdata = "";
  //     paramdata = this.cs.encrypt({ matter: this.selection.selected[0].matterNumber, matterdesc: this.selection.selected[0].description, pageflow: data, code: data != 'New' ? this.selection.selected[0].timeTicketNumber : null});
  //        const url = this.router.serializeUrl(
  //         this.router.createUrlTree(['/main/accounts/timeticket/' + paramdata])
  //       );
