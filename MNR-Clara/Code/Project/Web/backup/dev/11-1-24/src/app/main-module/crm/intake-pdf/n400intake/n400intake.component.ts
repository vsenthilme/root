...
let headerArray201:any[]=[];
 ...
 dd.content.push(
   ...
   let headerArray186:any[]=[];
      ...
      if(element.clientGeneralInfo.questions.haveYouFiledTaxesDuringLast3Years!="true"){
       ...
       dd.content.push(
        ...
        console.log(element.clientGeneralInfo.questions.howManyPeopleLiveWithYou);
        let headerArray1101: any[] = [];
        headerArray1101.push([
          { text: 'Public Charge Questions:', bold: true, fontSize: 10, border: [false, false, false, false],color: '#267FA0',margin:[0,5,0,5], },
          { text: ' ', bold: false, fontSize: 10, border: [false, false, false, false] },
       ...
       headerArray1102.push([
         { text: 'How many people live with you? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
      ...
      headerArray1103.push([
        { text: 'Do any of these individuals pay taxes alone? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
       
        { text: element.clientGeneralInfo.questions.doAnyOfTheIndividualPayTaxesAlone == "true" ? 'Yes' :  'No', bold: false, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
     ...
     let headerArray1104: any[] = [];
      headerArray1104.push([
        { text: 'If so, how many? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
     ...
     headerArray1105.push([
       { text: 'What is your annual household income(Include the income of the individuals who pay taxes with you.)? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
    ...
    headerArray1106.push([
      { text: 'Identify the total value of all your assets. (Such as house, cars, furniture, and any other items of value.) ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
   ...
   headerArray1107.push([
     { text: 'What is the highest degree or level of school you have completed? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  let headerArray1108: any[] = [];
   headerArray1108.push([
     { text: 'List your certifications, licenses, skills, obtained through work experience and educational experience. ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  let headerArray1110: any[] = [];
   headerArray1110.push([
     { text: 'Have you ever received Supplemental Security Income (SSI), Temporary Assistance for Needy Families (TANF), or State, Tribal, Territorial or local, cash benefit programs for income maintenance (often called “General Assistance” in the State context, but which also exist under other names)? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
    
     { text: element.clientGeneralInfo.questions.haveYouReceivedAnySupplementaryIncomeOrTemporaryAssisstance == "true" ? 'Yes':'No' , bold: false, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  let headerArray1115: any[] = [];
   headerArray1115.push([
     { text: 'If your answer to above question is “Yes”, list the specific benefit (s) you received,the start and end dates of each period of receipt, and the dollar amount of befits you received ', bold: false, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  if(element.clientGeneralInfo.questions.haveYouReceivedAnySupplementaryIncomeOrTemporaryAssisstance == "true"){
    ...
    headerArray1111.push([
      { text: 'S No ', bold: true, fontSize: 10, border: [true, true, true, false],borderColor: ['#808080', '#808080', '#808080', '#808080']  },
      { text: 'Benefit Received ', bold: true, fontSize: 10, border: [true, true, true, false],borderColor: ['#808080', '#808080', '#808080', '#808080']  },
      { text: 'Start Date', bold: true, fontSize: 10, border: [true, true, true, false], borderColor: ['#808080', '#808080', '#808080', '#808080'] },
      { text: 'End Date', bold: true, fontSize: 10, border: [true, true, true, false] ,borderColor: ['#808080', '#808080', '#808080', '#808080'] ,},
      { text: 'Dollar Amount ', bold: true, fontSize: 10, border: [true, true, true, false],borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  ;
   ...
   headerArray1113.push([
     { text: 'Have you ever received long-term institutionalization at government expense.? ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
    
     { text: element.clientGeneralInfo.questions.haveYouReceivedLongTermInstitutionalizationAtGovtExpense == "true" ? 'Yes':'No' , bold: false, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  let headerArray1116: any[] = [];
   headerArray1116.push([
     { text: 'If your answer to above question is “Yes”, list the list the name, city, and statefor each institution, the start and end dates of each period of institutionalization, and the reason you were institutionalized.  ', bold: true, fontSize: 10, border: [true, true, true, true] ,borderColor: ['#808080', '#808080', '#808080', '#808080']  },
  ...
  if(element.clientGeneralInfo.questions.haveYouReceivedLongTermInstitutionalizationAtGovtExpense == "true"){
    ...
    headerArray1118.push([
      ...
      { text: 'Name of the Institution ', bold: true, fontSize: 10, border: [true, true, true, false],borderColor: ['#808080', '#808080', '#808080', '#808080']  },
      { text: 'City and State', bold: true, fontSize: 10, border: [true, true, true, false],borderColor: ['#808080', '#808080', '#808080', '#808080']  },
      { text: 'Start Date', bold: true, fontSize: 10, border: [true, true, true, false], borderColor: ['#808080', '#808080', '#808080', '#808080'] },
      { text: 'End Date', bold: true, fontSize: 10, border: [true, true, true, false] ,borderColor: ['#808080', '#808080', '#808080', '#808080'] ,},
      { text: 'Reason', bold: true, fontSize: 10, border: [true, true, true, false],borderColor: ['#808080', '#808080', '#808080', '#808080']  },
    ...
    dd.content.push(
     {
      ...
      let headerArray198:any[]=[];
       headerArray198.push([
         ...
         { text: element.clientGeneralInfo.haveYouEverAskedForAnyPubilcAssistance  == "true" ?' Yes' :  element.clientGeneralInfo.haveYouEverAskedForAnyPubilcAssistance  == "false" ? 'No'  : 'NA', bold: false, fontSize: 10, border: [true, true, true, true],borderColor: ['#808080', '#808080', '#808080', '#808080']   },
