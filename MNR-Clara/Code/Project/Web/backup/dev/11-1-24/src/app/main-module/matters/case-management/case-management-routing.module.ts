...
const routes: Routes = [
 ...
 // { path: 'chequerequest/:code', component: ChequerequestComponent, pathMatch: 'full', data: { title: 'Accounting', module: 'Matter' } },//added by Karthik
 {path: 'expenses/chequerequest/:code', component: ExpensesChequeComponent, pathMatch: 'full', data: { title: 'Accounting', module: 'Matter' } },//added by Karthik
