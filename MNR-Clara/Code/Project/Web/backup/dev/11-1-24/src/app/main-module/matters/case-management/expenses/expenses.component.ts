...
export class ExpensesComponent implements OnInit {
  ...
  displayedColumns = ['select', 'action', 'expenseCode', 'download', 'referenceField5', 'expenseType', 'expenseDescription', 'expenseAmount', 'statusIddes','referenceField2','createdOn', 'createdBy','referenceField1',];
  ...
  constructor(public dialog: MatDialog,
    ...
    private cs: CommonService, private downloadApi: documentTemplateService,
    private cas: CommonApiService,
    private excel: ExcelService,
    private fb: FormBuilder,
    public auth: AuthService, private sanitizer: DomSanitizer,) { }
  matterno: any = "";
  RA: any = {};
  ngOnInit(): void {

    if(this.auth.userTypeId == 7){
      this.displayedColumns = ['select', 'action', 'expenseCode', 'download', 'referenceField5', 'expenseType', 'expenseDescription', 'expenseAmount', 'statusIddes','referenceField2','createdOn', 'createdBy','referenceField1',];
    }else{
      this.displayedColumns = ['select', 'action', 'expenseCode', 'referenceField5', 'expenseType', 'expenseDescription', 'expenseAmount', 'statusIddes','referenceField2','createdOn', 'createdBy','referenceField1',];
    }
  ...
  //       return;
  //     }
  //   const dialogRef = this.dialog.open(ChequerequestComponent, {
  //     disableClose: true,
  //     width: '50%',
  //     maxWidth: '80%',
  //     position: { top: '6.5%' },
