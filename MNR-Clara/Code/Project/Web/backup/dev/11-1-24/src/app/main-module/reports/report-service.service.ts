...
getAcademyReport(obj:any){
  ...
  getBilledPaidHoursPartner(obj: any) {
    return this.http.post<any>('/mnr-accounting-service/dashboard/partnerBilledHoursPaid', obj);
  }
  ...
  getImmigtationPayment(obj: any) {
    return this.http.post<any>('/mnr-accounting-service/invoiceheader/immigrationPaymentPlanReport', obj);
  }
