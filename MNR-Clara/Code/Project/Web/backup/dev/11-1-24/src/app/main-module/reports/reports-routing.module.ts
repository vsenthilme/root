...
import { BilledHrsPartnerComponent } from './accounting/billed-hrs-partner/billed-hrs-partner.component';
...
const routes: Routes = [
  ...
  { path: 'immigrationPayment', component: ImmigrationPaymentComponent, pathMatch: 'full', data: { title: 'Immigration Payment Plan', module: 'Reports' } },
  ...
  { path: 'billedHoursPaidPartner', component: BilledHrsPartnerComponent, pathMatch: 'full', data: { title: 'Billed Hours Paid', module: 'Reports' } },
