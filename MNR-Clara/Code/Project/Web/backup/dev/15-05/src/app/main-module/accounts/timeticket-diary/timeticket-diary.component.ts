...
export class TimeticketDiaryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select','clientId', 'matterNumber','stimeTicketDate', 'timeTicketDescription', 'approvedBillableTimeInHours', 'approvedBillableAmount',  'timeTicketHours', 'timeTicketAmount', 'taskCode',   'activityCode','timeTicketNumber',   'timeKeeperCode','defaultRate',  'billType', 'statusIddes', 'screatedOn',  'classId', ];
