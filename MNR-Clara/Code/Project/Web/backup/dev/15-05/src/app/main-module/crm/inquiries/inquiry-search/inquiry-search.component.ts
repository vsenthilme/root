...
this.field = true;
  ...
  search() {
    ...
    this.searhform.controls.sInqEndDate.patchValue(this.cs.dateNewFormat(this.searhform.controls.inqEndDate.value));
    this.searhform.controls.sInqStartDate.patchValue(this.cs.dateNewFormat(this.searhform.controls.inqStartDate.value));
    let classIdList: any[] = []
    this.spin.show();
