...
export class TimeticketDiaryComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'classId','clientId', 'matterNumber','timeTicketNumber', 'stimeTicketDate', 'screatedOn', 'billType', 'timeTicketHours', 'approvedBillableTimeInHours', 'timeTicketAmount', 'approvedBillableAmount', 'activityCode', 'timeTicketDescription',  'taskCode', 'defaultRate',  'timeKeeperCode', 'statusIddes'];
