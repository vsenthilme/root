...
export class TimeTicketsComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'timeTicketNumber', 'timeKeeperCode', 'createdOn', 'billType', 'timeTicketHours', 'defaultRate1', 'assignedRate','approvedBillableAmount', 'statusIddes','referenceField1'];
