...
export class GeneralListComponent implements OnInit {
  ...
  search() {
    ...
    this.searhform.controls.sFromDate.patchValue(this.cs.day_callapiSearch(this.searhform.controls.fromDate.value));
    this.searhform.controls.sEndDate.patchValue(this.cs.day_callapiSearch(this.searhform.controls.endDate.value));
