...
export class BillComponent implements OnInit {
  ...
  toggle = true;
  displayedColumns: string[] = ['statusicon', 'select', 'invoiceNumber', 'matterNumber', 'preBillNumber','invoiceDate', 'partnerAssigned', 'remainderdate', 'textFile', 'invoiceAmount', 'totalPaidAmount', 'remainingBalance', 'paymentlink', 'statusIddes'];
