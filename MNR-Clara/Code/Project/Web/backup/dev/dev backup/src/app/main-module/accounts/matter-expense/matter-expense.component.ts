...
export class MatterExpenseComponent implements OnInit {
  ...
  displayedColumns: string[] = ['select', 'action', 'expenseCode','clientid','matterno','referenceField1', 'referenceField5',  'expenseDescription', 'expenseAmount', 'statusIddes', 'referenceField2','createdOn', 'createdBy',];
