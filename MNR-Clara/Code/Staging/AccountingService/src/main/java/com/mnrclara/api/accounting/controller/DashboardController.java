...
public class DashboardController {
	...
	@PostMapping("/partnerBilledHoursPaid")
	public ResponseEntity<?> getPartnerBilledHoursPaidReport (@RequestBody BilledHoursPaid requestData)
			throws Exception {
		List<BilledHoursPaidReport> data = dashboardService.getPartnerBilledHoursPaidReport(requestData);
		return new ResponseEntity<>(data, HttpStatus.OK);
	}
