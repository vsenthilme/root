...
import com.mnrclara.api.management.model.matterexpense.AddMatterExpense;
...
import com.mnrclara.api.management.model.matterexpense.UpdateMatterExpense;
...
public class MatterExpenseService {
	...
	public MatterExpense createMatterExpense (AddMatterExpense newMatterExpense, String loginUserID) 
		...
		dbMatterExpense.setCheckRequestCreatedBy(loginUserID);
		dbMatterExpense.setCreatedOn(new Date());
		dbMatterExpense.setUpdatedOn(new Date());
		dbMatterExpense.setCheckRequestCreatedOn(new Date());
