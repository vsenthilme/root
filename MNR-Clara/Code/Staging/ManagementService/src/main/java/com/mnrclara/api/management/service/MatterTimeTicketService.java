...
//				timeKeeperBillingReportInput.getClassId()
		...
		for(ITimeKeeperDetail newTimeKeeperDetail : timeKeeperDetails) {
			...
			ITimeKeeperBillableHoursReport timeKeeperBillableHoursReportBillable = matterTimeTicketRepository.findTimeKeeperTimeTicketHoursBillable(
...
//			ITimeKeeperBillableHoursReport timeKeeperInvoiceAmount = matterTimeTicketRepository.findTimeKeeperInvoice(
//					newTimeKeeperDetail.getTimeKeeperCode(),
//					timeKeeperBillingReportInput.getStartDate(),
//					timeKeeperBillingReportInput.getEndDate()
//			);
			...
			if (timeKeeperBillableHoursReportBillable != null) {
				...
				dbTimeKeeperBillingReport.setBillableHours(timeKeeperBillableHoursReportBillable.getBillableHours());
			}
...
//			if (timeKeeperBillableHoursReportBillable != null && timeKeeperBillableHoursReportNonBillable != null) {
//				if (timeKeeperBillableHoursReportBillable.getBilledHours() != null && timeKeeperBillableHoursReportNonBillable.getBilledHours() != null) {
//					dbTimeKeeperBillingReport.setBilledHours(timeKeeperBillableHoursReportBillable.getBilledHours() +
//							timeKeeperBillableHoursReportNonBillable.getBilledHours());
//				}
//			}
			if (timeKeeperBillableHoursReportBillable != null ) {
				if (timeKeeperBillableHoursReportBillable.getBilledHours() != null ) {
					dbTimeKeeperBillingReport.setBilledHours(timeKeeperBillableHoursReportBillable.getBilledHours());
				}
			}

//			if(timeKeeperInvoiceAmount != null) {
//
//				dbTimeKeeperBillingReport.setBilledFees(timeKeeperInvoiceAmount.getBilledFees());
//			}

			if(timeKeeperBillableHoursReportBillable.getBilledFees() != null) {

				dbTimeKeeperBillingReport.setBilledFees(timeKeeperBillableHoursReportBillable.getBilledFees());
...
//			if(timeKeeperInvoiceAmount != null && dbTimeKeeperBillingReport.getBilledHours() != null) {
//
//				dbTimeKeeperBillingReport.setActualRates(timeKeeperInvoiceAmount.getBilledFees() /
//															dbTimeKeeperBillingReport.getBilledHours());
//			}
			if(timeKeeperBillableHoursReportBillable.getBilledFees() != null && dbTimeKeeperBillingReport.getBilledHours() != null) {

				dbTimeKeeperBillingReport.setActualRates(timeKeeperBillableHoursReportBillable.getBilledFees() /
						dbTimeKeeperBillingReport.getBilledHours());
			}
